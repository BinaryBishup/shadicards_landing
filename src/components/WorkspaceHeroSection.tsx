...
import { 
  ...
  UserCheck, Check, Phone, ArrowRight
} from "lucide-react";
  ...
  return (
    <section className="min-h-screen py-16 bg-[rgb(254.7,255,235)] overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        {/* Main Interface - Overlapped Layout */}
        <div className="max-w-7xl mx-auto relative">
          <div className="relative">
            ...
            {/* Glass Effect Feature Selection Card - Overlapping */}
            <div className="absolute bottom-10 right-10 z-10" style={{ maxWidth: '420px' }}>
              <div className="bg-white/92 backdrop-blur-2xl rounded-2xl shadow-2xl p-5 border border-white/80">
                  {/* Section Header */}
                      ...
                      <button
                        ...
                        className={`relative group p-3 rounded-xl border-2 transition-all duration-200 hover:shadow-lg ${
                          selectedFeatures.has(feature.id)
                            ? 'border-rose-400 bg-rose-50/80 backdrop-blur-sm'
                            : 'border-gray-200 bg-white/50 hover:border-gray-300 backdrop-blur-sm'
                        }`}
                      >
                        {/* Checkbox */}
