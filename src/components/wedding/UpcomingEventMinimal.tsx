        ...
        <div className="bg-black/20 backdrop-blur-sm border-b border-white/10">
          <div className="container mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              {/* Previous Event */}
              <Link 
                href={prevEvent ? `/website/${website.url_slug}/upcoming_event?guest=${guest.id}&event=${prevEvent.id}` : '#'}
                className={cn(
              ...
              {/* Next Event */}
              <Link 
                href={nextEvent ? `/website/${website.url_slug}/upcoming_event?guest=${guest.id}&event=${nextEvent.id}` : '#'}
                className={cn(
                  "flex items-center gap-2 text-white/80 hover:text-white transition-colors",
