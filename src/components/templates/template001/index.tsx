...
export default function Template001({ data, primaryColor = '#ec4899', secondaryColor = '#f97316', visibility }: TemplateComponentProps) {
  console.log("🌸 TEMPLATE001 (Elegant Romance) IS RENDERING");
